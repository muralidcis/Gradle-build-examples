 ...
 * @version $revision$
 * @author Jakob Jenkov
 * @Customization Selvakumar Loganathan
 * $Author$
 * $Date$
 * $Id$
 * $Rev $
...
//    protected Set         preservedSelected   = new TreeSet();
    ...
    public void expand(String treeNodeId) {
        ...
        // Commented out since in ID 2.0 we may have different significance
        // other than collapsingAll and expanding the requested node.
        // TODO:
        // collapseAll();
