...
public class AddressValidation3Locator extends org.apache.axis.client.Service implements com.serviceobjects.www.AddressValidation3 {
    ...
    public AddressValidation3Locator(String soapAddress) {
    ...
    public com.serviceobjects.www.IAddressValidation3 getsoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.serviceobjects.www.IAddressValidation3 getsoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.serviceobjects.www.SoapStub _stub = new com.serviceobjects.www.SoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.serviceobjects.www.IAddressValidation3.class.isAssignableFrom(serviceEndpointInterface)) {
                com.serviceobjects.www.SoapStub _stub = new com.serviceobjects.www.SoapStub(new java.net.URL(soap_address), this);
                _stub.setPortName(getsoapWSDDServiceName());
                return _stub;
            }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://www.serviceobjects.com", "soap"));
        }
